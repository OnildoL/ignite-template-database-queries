...
// return this.repository.query(`SELECT LOWER(first_name) AND LOWER(last_name) FROM queries_challenge WHERE first_name = ILIKE '%${first_name}%'`); // Complete usando raw query